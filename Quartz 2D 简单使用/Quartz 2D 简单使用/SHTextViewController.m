...
#import "SHTextViewController.h"

@interface SHTextViewController ()

@end

@implementation SHTextViewController
...
-(void)addTextView{
    SHTextDrawView *drawView = [[SHTextDrawView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight-64)];
